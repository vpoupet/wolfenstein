...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'wolflib.data';
      var REMOTE_PACKAGE_BASE = 'wolflib.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_wolflib.data');

      };
      Module['addRunDependency']('datafile_wolflib.data');
   ...
   loadPackage({"files": [{"filename": "/00.map", "start": 0, "end": 4096}, {"filename": "/VSWAP.WL6", "start": 4096, "end": 1549496}], "remote_package_size": 1549496, "package_uuid": "4abd1452-6ff7-4f43-8330-ab88ac5dddc4"});
...
/** @type {function(...*):?} */
var _get_view_ptr = Module["_get_view_ptr"] = createExportWrapper("get_view_ptr");

/** @type {function(...*):?} */
var _get_map_ptr = Module["_get_map_ptr"] = createExportWrapper("get_map_ptr");
...
/** @type {function(...*):?} */
var _update_view = Module["_update_view"] = createExportWrapper("update_view");
